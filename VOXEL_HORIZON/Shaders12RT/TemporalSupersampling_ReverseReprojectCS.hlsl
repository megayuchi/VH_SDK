...
Texture2D<float2> g_inCurrentFrameLinearDepthDerivative : register(t0);
Texture2D<uint> g_inReprojectedNormalDepth : register(t1); 
Texture2D<float2> g_inTextureSpaceMotionVector : register(t2);
Texture2D<uint> g_inCachedNormalDepth : register(t3);
Texture2D<float> g_inCachedValue : register(t4);
Texture2D<uint2> g_inCachedTspp : register(t5);
Texture2D<float> g_inCachedValueSquaredMean : register(t6);
Texture2D<float> g_inCachedRayHitDepth : register(t7);
